...
INSERT INTO "ArtDefine_UnitInfos" ('Type','DamageStates','Formation')
	SELECT	REPLACE("Type", '_SOUTHAS', '_INDIA'), "DamageStates", "Formation"
	FROM "ArtDefine_UnitInfos" WHERE Type LIKE '%_SOUTHAS';
INSERT INTO "ArtDefine_UnitInfoMemberInfos" ('UnitInfoType','UnitMemberInfoType','NumMembers')
	SELECT	REPLACE("UnitInfoType", '_SOUTHAS', '_INDIA'), "UnitMemberInfoType", "NumMembers"
	FROM "ArtDefine_UnitInfoMemberInfos" WHERE UnitInfoType LIKE '%_SOUTHAS';
...
INSERT INTO "ArtDefine_UnitInfos" ('Type','DamageStates','Formation')
	SELECT	REPLACE("Type", '_OCEAN', '_POLYNESIA'), "DamageStates", "Formation"
	FROM "ArtDefine_UnitInfos" WHERE Type LIKE '%_OCEAN';
INSERT INTO "ArtDefine_UnitInfoMemberInfos" ('UnitInfoType','UnitMemberInfoType','NumMembers')
	SELECT	REPLACE("UnitInfoType", '_OCEAN', '_POLYNESIA'), "UnitMemberInfoType", "NumMembers"
	FROM "ArtDefine_UnitInfoMemberInfos" WHERE UnitInfoType LIKE '%_OCEAN';
...
UPDATE MinorCivilizations SET ArtStyleSuffix = "_HUNS" WHERE Type IN 
	('MINOR_CIV_ALMATY',
	'MINOR_CIV_KYZYL');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_ROME" WHERE Type IN 
	('MINOR_CIV_FLORENCE',
	'MINOR_CIV_GENOA');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_CHINA" 
	WHERE Type = 'MINOR_CIV_HONG_KONG';
--UPDATE MinorCivilizations SET ArtStyleSuffix = "_INDIA" WHERE Type IN 
--	('MINOR_CIV_COLOMBO', 
--	'MINOR_CIV_LHASA');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_VENICE" WHERE Type IN 
	('MINOR_CIV_MILAN',
	'MINOR_CIV_VENICE');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_FRANCE" 
	WHERE Type = 'MINOR_CIV_MONACO';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_GERMANY" 
	WHERE Type = 'MINOR_CIV_WITTENBERG';
--UPDATE MinorCivilizations SET ArtStyleSuffix = "_POLYNESIA" 
--	WHERE Type = 'MINOR_CIV_WELLINGTON');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_CELTS" WHERE Type IN
	('MINOR_CIV_DUBLIN',
	'MINOR_CIV_EDINBURGH');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_SWEDEN" WHERE Type IN 
	('MINOR_CIV_HELSINKI',
	'MINOR_CIV_STOCKHOLM');
UPDATE MinorCivilizations SET ArtStyleSuffix = "_INDONESIA" 
	WHERE Type = 'MINOR_CIV_JAKARTA';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_MOROCCO" 
	WHERE Type = 'MINOR_CIV_MARRAKECH';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_PORTUGAL" 
	WHERE Type = 'MINOR_CIV_LISBON';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_DENMARK" 
	WHERE Type = 'MINOR_CIV_OSLO';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_BRAZIL" 
	WHERE Type = 'MINOR_CIV_RIO_DE_JANEIRO';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_KOREA" 
	WHERE Type = 'MINOR_CIV_SEOUL';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_AUSTRIA" 
	WHERE Type = 'MINOR_CIV_VIENNA';
UPDATE MinorCivilizations SET ArtStyleSuffix = "_POLAND" 
	WHERE Type = 'MINOR_CIV_WARSAW';

-----------------------------------------------------------------------------
-- MOD SUPPORT
-----------------------------------------------------------------------------
--[This list is derived from the Cultural Diversity mod, with a few additions.  
--Note the next version of CulDiv will include an ArtDefineTag column in the 
--custom Civilization_JFD_CultureType table that will need to be copied to the 
--ArtStyleSuffix column in the Civilizations table.  I plan to add support 
--when the feature is added.]

--[City-State Mods:]

UPDATE MinorCivilizations SET ArtStyleSuffix = "_OCEAN" WHERE Type IN
	('MINOR_CIV_BAMAGA', 
	'MINOR_CIV_HONIARA', 
	'MINOR_CIV_KOROR', 
	'MINOR_CIV_NAIN', 
	'MINOR_CIV_NOUMEA', 
	'MINOR_CIV_PORT_MORESBY', 
	'MINOR_CIV_SUVA', 
	'MINOR_CIV_PORT_VILA', 
	'MINOR_CIV_NEW_ZEALAND');


--[Major civs:]
--[Note this is repeated twice, one for exisiting civs, and one within a 
--trigger to account for civs activated after R.E.D.]
...
UPDATE Civilizations SET ArtStyleSuffix = "_SOUTHAS" WHERE Type IN 
	...
	'CIVILIZATION_TIBET_LS_MOD', 
	'CIVILIZATION_VIJAYANAGAR', 
	'CIVILIZATION_BANE_TIBET', 
	'CIVILIZATION_MC_TIBET');
