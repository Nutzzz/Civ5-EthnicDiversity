...
SELECT     'FINLAND',                 1,     '_NORTHEU',       '',           '',                 ''                 UNION ALL
SELECT     'FLANDERS_LS_MOD',         1,     '_BELGIUM',       '',           '',                 ''                 UNION ALL
SELECT     'GE_SLAVS',                1,     '_EASTEU',        '',           '',                 ''                 UNION ALL
SELECT     'GENOA_LS_MOD',            1,     '_MED',           '',           '',                 ''                 UNION ALL
SELECT     'GOTHS_LS_MOD',            1,     '_GOTHS',         '_NORTHEU',   '',                 ''                 UNION ALL
...
SELECT     'JFD_GERMANS',             1,     '_GERMANY',       '',           '',                 ''                 UNION ALL
SELECT     'JFD_PHILIPPINES',         1,     '_SEASIA',        '',           'POLYNESIAN',       ''                 UNION ALL
SELECT     'JFD_USSR_STALIN',         1,     '_RUSSIA',        '_EASTEU',    '',                 ''                 UNION ALL
...
SELECT     'SCYTHIA_LS_MOD',          1,     '_OTTOMAN',       '_MIDEAST',   '',                 ''                 UNION ALL
...
SELECT     'TCM_OSTROGOTH',           1,     '_GOTHS',         '_NORTHEU',   '',                 ''                 UNION ALL
SELECT     'TCM_VISIGOTH',            1,     '_GOTHS',         '_NORTHEU',   '',                 ''                 UNION ALL
SELECT     'TIMURIDES',               1,     '_CENTAS',        '',           '',                 ''                 UNION ALL
SELECT     'TIMURIDS_LS_MOD',         1,     '_CENTAS',        '',           '',                 ''                 UNION ALL
SELECT     'TIMURIDS_MOD',            1,     '_CENTAS',        '',           '',                 ''                 UNION ALL
...
SELECT     'VISIGOTHS_MOD',           1,     '_GOTHS',         '_NORTHEU',   '',                 ''                 UNION ALL
