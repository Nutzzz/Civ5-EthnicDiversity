...
UPDATE ArtDefine_UnitInfoMemberInfos  SET UnitInfoType = 'ART_DEF_UNIT_BARBARIAN_BRUTE' 
									WHERE UnitInfoType = 'ART_DEF_UNIT_BARBARIAN_EURO';
UPDATE ArtDefine_UnitInfoMemberInfos  SET UnitMemberInfoType = 'ART_DEF_UNIT_MEMBER_BARBARIAN_BRUTE' 
									WHERE UnitMemberInfoType = 'ART_DEF_UNIT_BARBARIAN_EURO_ALPHA';
UPDATE ArtDefine_UnitInfoMemberInfos  SET UnitMemberInfoType = 'ART_DEF_UNIT_MEMBER_BARBARIAN_BRUTE_V2' 
									WHERE UnitMemberInfoType = 'ART_DEF_UNIT_BARBARIAN_EURO_BRAVO';
UPDATE ArtDefine_UnitInfoMemberInfos  SET UnitMemberInfoType = 'ART_DEF_UNIT_MEMBER_BARBARIAN_BRUTE_V3' 
									WHERE UnitMemberInfoType = 'ART_DEF_UNIT_BARBARIAN_EURO_CHARLIE';
...
--	FROM ArtDefine_UnitMemberInfos JOIN EDUnitGraphicConfiguration ON UC_fxsxml <> '' AND UC_Scale1 ISNULL;
...
--	JOIN EDUnitGraphicConfiguration ON UC_fxsxml <> '' AND UC_Num1 ISNULL;
...
--	JOIN EDUnitGraphicConfiguration ON UC_fxsxml <> '' AND UC_Form1 ISNULL 
...
--	JOIN EDUnitGraphicConfiguration AS u2 ON u2.UC_Form1 NOT NULL AND u2.UC_Template = u1.UC_Template AND u2.UC_Suffix = u1.UC_Fallback 
...
--	FROM ArtDefine_UnitInfos 
--	JOIN EDUnitGraphicConfiguration AS u1 ON u1.UC_fxsxml = '' AND u1.UC_Fallback <> '' 
--	JOIN EDUnitGraphicConfiguration AS u2 ON u2.UC_Form1 ISNULL AND u2.UC_Template = u1.UC_Template AND u2.UC_Suffix = u1.UC_Fallback 
--	WHERE Type = 'ART_DEF_UNIT_' || u1.UC_Template;
